...
**Gated progression.** Each task has a gate — a specific, testable condition that must pass before the next task starts. Claude Code should not proceed past a gate until it has verified the condition manually or with a test script.
